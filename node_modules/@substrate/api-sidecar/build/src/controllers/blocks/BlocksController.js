...
class BlocksController extends AbstractController_1.default {
    constructor(api) {
        super(api, '/blocks', new services_1.BlocksService(api));
        /**
        ...
        this.getLatestBlock = async ({ query: { eventDocs, extrinsicDocs, finalized } }, res) => {
            ...
            const hash = finalized === 'false'
                ? (await this.api.rpc.chain.getHeader()).hash
                : await this.api.rpc.chain.getFinalizedHead();
            BlocksController.sanitizedSend(res, await this.service.fetchBlock(hash, eventDocsArg, extrsinsicDocsArg));
        };
        /**
        ...
        this.getBlockById = async ({ params: { number }, query: { eventDocs, extrinsicDocs } }, res) => {
            ...
            BlocksController.sanitizedSend(res, await this.service.fetchBlock(hash, eventDocsArg, extrinsinsicDocsArg));
        };
        this.initRoutes();
    }
    initRoutes() {
