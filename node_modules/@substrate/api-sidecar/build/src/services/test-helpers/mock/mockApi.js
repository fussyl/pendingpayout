...
exports.mockApi = exports.tx = exports.pendingExtrinsics = exports.submitExtrinsic = exports.queryInfoBalancesTransfer = exports.ledgerAt = exports.bondedAt = exports.erasStartSessionIndexAt = exports.activeEraAt = exports.getBlock = void 0;
const decorated_1 = require("../../../test-helpers/metadata/decorated");
...
exports.getBlock = (_hash) => Promise.resolve().then(() => {
    return { block: _1.mockBlock789629 };
});
...
const getMetadata = () => Promise.resolve().then(() => decorated_1.decoratedPolkadotMetadata.metadata);
...
exports.activeEraAt = (_hash) => Promise.resolve().then(() => registries_1.polkadotRegistry.createType('Option<ActiveEraInfo>', {
    index: 49,
    start: 1595259378000,
}));
exports.erasStartSessionIndexAt = (_hash, _activeEra) => Promise.resolve().then(() => registries_1.polkadotRegistry.createType('Option<SessionIndex>', 330));
...
exports.queryInfoBalancesTransfer = (_extrinsic, _hash) => Promise.resolve().then(() => registries_1.polkadotRegistry.createType('RuntimeDispatchInfo', {
    weight: 195000000,
    class: 'Normal',
    partialFee: 149000000,
}));
exports.submitExtrinsic = (_extrinsic) => Promise.resolve().then(() => registries_1.polkadotRegistry.createType('Hash'));
...
exports.pendingExtrinsics = () => Promise.resolve().then(() => registries_1.polkadotRegistry.createType('Vec<Extrinsic>'));
exports.tx = () => registries_1.polkadotRegistry.createType('Extrinsic', _1.balancesTransferValid);
/**
